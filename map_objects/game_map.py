...
from random_utilis import random_choice_from_dict, from_dungeon_level
...
class GameMap:
    ...
    # Cree un nombre de salles inferieur a un nombre fixe (s'arrete lorsque la generation aleatoire crée
    # deux pieces superposees. Place le joueur dans la premiere d'entre elles, puis connecte la nouvelle salle avec
    # la precedente et enfin ajoute les escaliers a la liste des entites du jeu
    ...
    # Fait passer le joueur a l'etage suivant, lui rend de la vie et genere une nouvelle carte.
